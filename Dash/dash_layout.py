...
app.layout = dbc.Container([
    dbc.Row([
        html.Div('''Reducing CO2 Emissions in Singapore's Public Bus Network''', className="text-primary text-center fs-4")
    ]),
    dbc.Row([
        dbc.Col([
        ...
        dbc.Col([
            ...
            dbc.Row([
                ...
                dbc.Col(dbc.Card(id="card_assumption", color="success")) 
                    ], style={"height": "40vh",
                              'margin-top': '20px', 
                              'margin-left': '8px',
                              'margin-bottom': '20px', 
...
def update_graph(col_chosen):
    ...
    sum_df.loc[sum_df['Vehicle_type'] == 'co2_by_car','Vehicle_type'] = 'Private Car' # rename for label
    sum_df.loc[sum_df['Vehicle_type'] == 'co2_by_bus','Vehicle_type'] = 'Electric bus' # rename for label
    ...
    fig_route.add_traces(px.line_mapbox(df, lat="Latitude", lon="Longitude").data)
